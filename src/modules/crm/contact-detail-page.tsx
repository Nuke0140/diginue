...
import { mockContacts, mockActivities, mockDeals, mockTasks, mockNotes } from '@/modules/crm/data/mock-data';
import ActivityTimeline from './components/activity-timeline';
import type { AiIntent } from '@/modules/crm/types';
...
export default function ContactDetailPage() {
  ...
  const { selectedContactId, selectCompany } = useCrmStore();
